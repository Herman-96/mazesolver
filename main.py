...
class Window():
    def __init__(self, width, height):
        ...
        self.w = Canvas(self.__root, height=self.height, width=self.width)
        self.w.pack()
        self.running = False
...
class Cell():
    ...
    def draw_move(self, to_cell, undo=False):
        ...
        # Determine the line color based on the 'undo' flag
        fill_color = "red"
        if undo:
            fill_color = "gray"

        # Create a Line object between the two centers and draw it
